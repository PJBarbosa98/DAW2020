  ...
  let pagHTML = `
    <html>
        ...
        <body>
            ...
            <form class="w3-container w3-margin-top" action="/files" method="POST" enctype="multipart/form-data">
              ...
              <button class="w3-btn w3-teal w3-margin-bottom"
              style="display: block;" onclick='newFileForm()'>Add One More</button>
