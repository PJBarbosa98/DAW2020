...
passport.serializeUser((user, done) => {
	...
	// serialização do utilizador. o passport grava o utilizar na sessão aqui.
	done(null, user.id);
});
...
// tem que estar depois da inicialização das sessões
// e antes dos app.use das rotas ('/' e '/users')
